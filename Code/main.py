...
x_train_merged = np.zeros((0, Config.input_channels, Config.num_of_samples))
...
for i in range(Config.IMU_to_train):
    ...
    # Data loaders
    X_train, X_val, y_train, y_val = train_test_split(x_train_merged, y_train_merged, test_size=0.4, random_state=seed)
    ...
    val_loader = DataLoader(val_dataset, batch_size=CNNet.batch_size, shuffle=True)
    ...
    for epoch in range(CNNet.epochs):
        ...
        if epoch % 5 == 0:
            ...
            if not os.path.isdir('/home/ystolero/Documents/Research/Simulation/checkpoints'):
                os.mkdir('/home/ystolero/Documents/Research/Simulation/checkpoints')
            torch.save(state, f'//home/ystolero/Documents/Research/Simulation/checkpoints/1d_cnn_ckpt_{i}.pth')
