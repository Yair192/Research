    ...
    for i in range(Config.IMU_to_train):
        ...
        for epoch in range(CNNet.epochs):
            ...
            if val_loss < min_val:
                ...
                if not os.path.isdir(f'/home/ystolero/Documents/Research/Simulation/checkpoints_raise_input/run_{k}'):
                    os.mkdir(f'/home/ystolero/Documents/Research/Simulation/checkpoints_raise_input/run_{k}')
                torch.save(state,
