...
for k in range(Config.runs):
    x_train_merged = np.zeros((Config.N, 0, Config.samples_to_train))
    ...
    for i in range(Config.IMU_to_train):
        ...
        model = CNNet.CNN1D(input_channels)
        ...
        for epoch in range(CNNet.epochs):
            ...
            if epoch == 4:
                ...
                if not os.path.isdir(f'/home/ystolero/Documents/Research/Simulation/checkpoints_avg_on_outputs/run_{k}'):
                    os.mkdir(f'/home/ystolero/Documents/Research/Simulation/checkpoints_avg_on_outputs/run_{k}')
                torch.save(state,
                           f'//home/ystolero/Documents/Research/Simulation/checkpoints_avg_on_outputs/run_{k}/1d_cnn_ckpt_{i}.pth')
